    ...
    <Container>
      ...
      >
        ...
        <p className="my-6 font-light">
          Hello, I'm Jeferson, a technology enthusiast! Since childhood, I
          always knew this would be my place! I find it fascinating how logic
          works and, especially, how it's enhanced. I'm a student of Systems
          Analysis and Development, delving deeper into Front-end and Back-end.
          When I'm not studying, during my free time, I enjoy watching YouTube
          videos about development with React, TypeScript, Node, Java, among
          others. As I mentioned: a technology enthusiast!
        </p>
